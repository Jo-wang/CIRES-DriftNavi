...
def toggle_wizard(n_clicks_open, n_clicks_next, is_open, modal_style, menu_dataset_style, menu_export_style, menu_model_style, menu_view_style, menu_prompt_style,
    ...
    steps = [
        ...
        },
        {
            ...
            "body": "You can export the chat history and the generated drift management report here.",
            "top": "50px",
            "left": "-400px",
        ...
        {
            "title": "drift Management Pipeline",
            "body": "Display what stage you are at in the drift management pipeline. You can either manually choose or "
        ...
        },
        {
            ...
            "body": "Type your query here to interact with AI to know more about the drift in your dataset. RAG can be "
        ...
        },
        {
            ...
            "body": "After editing your dataset, you can evaluate your dataset here to see if the drift is mitigated.",
            "top": "300px",
            "left": "300px",
        ...
        },
        {
            ...
            "body": "You can analyze your dataset with DriftNavi and get a comprehensive report here.",
            "top": "600px",
            "left": "0px",
